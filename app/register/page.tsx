              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="relative block w-full rounded-lg border-0 py-3 pl-10 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
